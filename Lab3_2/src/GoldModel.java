...
public class GoldModel extends GameUtils {
    ...
    public GoldModel() {
        ...
        for (int i = 0; i < size.width; i++) {
            for (int j = 0; j < size.height; j++) {
                setGameboardState(board, i, j, BLANK_TILE);
            }
        }

        // Insert the collector in the middle of the gameboard.
        this.collectorPos = new Position(size.width / 2, size.height / 2);
        setGameboardState(board, this.collectorPos, COLLECTOR_TILE);
    ...
    private void addCoin() {
        ...
        setGameboardState(board, newCoinPos, COIN_TILE);
    ...
    public void gameUpdate(final int lastKey) throws GameOverException {
        ...
        setGameboardState(board, this.collectorPos, BLANK_TILE);
        ...
        this.coins.remove(0);
        setGameboardState(board, oldCoinPos, BLANK_TILE);
